...
const apiKey = "XIvRdlAg1yaIDtJIyK0Wf5ezGEMLwKTI";
...
const fetch_city = async (city) => {
    const cityAPI_link = `https://dataservice.accuweather.com/locations/v1/cities/search?apikey=${apiKey}&q=${city}`;
...
const fetch_weather = async (cityKey) => {
    const weatherAPI_link = `https://dataservice.accuweather.com/forecasts/v1/daily/1day/${cityKey}?apikey=${apiKey}&language=en`;
